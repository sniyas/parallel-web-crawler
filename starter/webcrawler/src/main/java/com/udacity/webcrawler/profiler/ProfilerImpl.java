...
final class ProfilerImpl implements Profiler {
  ...
  @Profiled
  public boolean isAnnotatedWithProfiled(Class<?> klass) throws IllegalArgumentException{
  ...
  public <T> T wrap(Class<T> klass, T delegate) throws IllegalArgumentException{
    ...
    if (!isAnnotatedWithProfiled(klass)) {
      throw new IllegalArgumentException(klass.getName() + "does not contain methods annotated with  profiled.");
